...
use x25519::PublicKey as DHPublicKey;
...
trait Crypto: Sized {
    ...
    fn dh_public_key<C: Crypto>(seed: SeedOf<C>) -> DHPublicKey {
        DHPublicKey::from(seed)
    }
        ...
        <Self::Pair as Pair>::Public: PublicT,
    {
        ...
        if let Ok((pair, seed)) = Self::Pair::from_phrase(uri, password) {
            ...
            let share_pub_key = Self::dh_public_key(&seed);
            ...
            match output {
                OutputType::Json => {
                    let json = json!({
						...
						"hdPublicKey": format_public_key::<Self>(share_pub_key.clone()),
                ...
                OutputType::Text => {
                    println!("Secret phrase `{}` is account:\n  \
						...
						SS58 Address:       {}",
                             ...
                             format_public_key::<Self>(share_pub_key.clone()),

...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("dico-dev-node"),
	impl_name: create_runtime_str!("dico-node"),
...
parameter_types! {
	...
	pub const EnactmentPeriod: BlockNumber = 6 * MINUTES;
...
parameter_types! {
	...
	pub const BountyUpdatePeriod: BlockNumber = 14 * MINUTES;
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = dico_primitives::Block,

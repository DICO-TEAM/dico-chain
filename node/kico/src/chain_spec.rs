...
pub fn mainnet_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../res/kico.json")[..])
}
...
fn testnet_genesis(
	...
	parachain_template_runtime::GenesisConfig {
		...
		currencies: parachain_template_runtime::CurrenciesConfig {
			assets: vec![(
				0,
				DicoAssetInfo {
					owner: get_root(),
